  ...
  return (
    <section className="relative h-screen w-full overflow-hidden bg-white">
      ...
      <div
        ...
        className="relative z-10 h-full overflow-y-auto px-4 md:px-8 pt-8 pb-48 md:pb-56 custom-scrollbar scroll-smooth"
      >
        {/* ================= Hero Logo Section (Empty State) ================= */}
        {!isChatActive && messages.length === 0 && (
          <div className="flex min-h-[60vh] flex-col items-center justify-center px-6 text-center pt-4">
        ...
        {/* ================= Messages List ================= */}
        {isChatActive && (
          <div className="mx-auto flex w-full max-w-4xl flex-col gap-6 px-2 sm:px-4 md:px-8 pt-10">
